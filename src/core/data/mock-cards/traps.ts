...
export const TRAP_CARDS: ICard[] = [
  ...
  createTrap({ id: "trap-openclaw-nullify-buff", name: "OpenClaw Bug Trap", description: "Cuando el rival buffea sus entities, las deja por DEBAJO de su valor original (resta el doble del buff).", renderFile: "trap-openclaw-nullify-buff", faction: "OPEN_SOURCE", cost: 2, trigger: "ON_OPPONENT_STAT_BUFF_APPLIED", effect: { action: "NULLIFY_OPPONENT_BUFF" } }),
