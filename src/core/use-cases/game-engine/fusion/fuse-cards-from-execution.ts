...
import { findPlayerFusionCard, getFusionRecipe } from "@/core/use-cases/game-engine/fusion/fusion-recipes";
...
export function fuseCardsFromExecution(
  ...
  const fusionCard = findPlayerFusionCard(player, recipeId);
