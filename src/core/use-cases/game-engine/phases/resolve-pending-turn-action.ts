...
import { resolveOpponentEntityToDestroySelectionAction, resolveOpponentEntityToLockSelectionAction, resolveOpponentGraveyardSelectionAction, resolveOpponentSetCardSelectionAction } from "@/core/use-cases/game-engine/phases/internal/resolve-opponent-selection-actions";
