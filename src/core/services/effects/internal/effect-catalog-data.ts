...
export const EXECUTION_EFFECTS: IEffectCatalogItem[] = [
  ...
  { category: "EXECUTION", key: "ALLOW_DEFENSE_MODE_ATTACK", name: "Atacar desde defensa", description: "Este turno, tus entidades en defensa pueden atacar usando su DEFENSA como ataque (a entities o directo), sin cambiar de modo.", exampleJson: '{"action":"ALLOW_DEFENSE_MODE_ATTACK"}' },
