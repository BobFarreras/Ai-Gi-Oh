...
export const TRAP_EFFECTS: IEffectCatalogItem[] = [
  ...
  { category: "TRAP", key: "NULLIFY_OPPONENT_BUFF", name: "Anular y penalizar buff rival", description: "Cuando el rival buffea sus entities, no solo lo anula: las deja por debajo de su valor original (resta el doble del buff a las buffeadas).", exampleJson: '{"action":"NULLIFY_OPPONENT_BUFF"}' },
