...
export const TRAP_EFFECTS: IEffectCatalogItem[] = [
  ...
  { category: "TRAP", key: "REINFORCE_LINKED_ENTITY_ON_ATTACK", name: "Escudo persistente ligado", description: "Cada vez que el rival ataca a tu entity ligada (linkedCardId), esa entity gana DEF (acumulable). La trampa no se consume: sigue puesta mientras la entity siga en el campo.", exampleJson: '{"action":"REINFORCE_LINKED_ENTITY_ON_ATTACK","linkedCardId":"entity-typescript","value":1000}' },
  ...
  { category: "TRAP", key: "NULLIFY_OPPONENT_BUFF", name: "Anular buff rival", description: "Cuando el rival buffea sus entities, resta ese mismo valor a las entities buffeadas (anula el buff).", exampleJson: '{"action":"NULLIFY_OPPONENT_BUFF"}' },
