  ...
  return (
    <div className="border border-cyan-900/50 bg-[#03101c]/80 p-4" style={{ clipPath: "polygon(10px 0,100% 0,100% calc(100% - 10px),calc(100% - 10px) 100%,0 100%,0 10px)" }}>
      <div className="mb-3 flex flex-wrap items-center gap-2">
        <span className="border border-cyan-700/50 bg-cyan-500/10 px-2 py-0.5 font-mono text-[10px] font-bold uppercase tracking-wider text-cyan-300">{draft.scope === "DAILY" ? "Diaria" : "Semanal"}</span>
        <span className="border border-fuchsia-700/40 bg-fuchsia-500/10 px-2 py-0.5 font-mono text-[10px] text-fuchsia-300">{draft.objectiveType}</span>
