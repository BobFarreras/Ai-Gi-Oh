...
export function StorySidebarHeader({ briefing }: IStorySidebarHeaderProps) {
  return (
    <div className="relative z-10 border-b border-cyan-500/30 bg-gradient-to-b from-slate-900/80 to-black/80 px-6 py-6 shadow-md">
      ...
      <h2 className="text-2xl font-black uppercase tracking-[0.1em] text-white drop-shadow-[0_0_12px_rgba(255,255,255,0.4)]">
        {briefing.arcTitle}
      </h2>
      <div className="relative mt-5 border border-cyan-500/40 bg-gradient-to-r from-cyan-950/80 to-slate-950/80 p-4 shadow-inner">
        ...
        <p className="mt-2 text-sm font-medium leading-relaxed text-cyan-50 drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]">
          {briefing.objective}
        </p>
      </div>
    </div>
