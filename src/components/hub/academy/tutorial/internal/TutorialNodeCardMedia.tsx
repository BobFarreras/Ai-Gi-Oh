  ...
  return (
    <div className="relative grid h-full w-full grid-cols-[1fr_auto_1fr] overflow-hidden bg-[#04111d]">
      <div className="relative">
        <Image src="/assets/story/player/intro-Jugador.webp" alt="Jugador" fill className="object-contain object-bottom" sizes="(max-width: 1024px) 40vw, 20vw" />
      </div>
      ...
      <div className="relative">
        <Image src="/assets/story/opponents/opp-ch1-biglog/intro-BigLog.webp" alt="BigLog" fill className="object-contain object-bottom" sizes="(max-width: 1024px) 40vw, 20vw" />
      </div>
