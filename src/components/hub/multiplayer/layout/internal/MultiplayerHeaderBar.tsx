  ...
  return (
    <header className="relative w-full rounded-xl border border-cyan-800/50 bg-[#041120]/90 p-2 shadow-[0_0_20px_rgba(8,145,178,0.15),inset_0_0_20px_rgba(0,0,0,0.6)] backdrop-blur-xl sm:px-4 sm:py-2.5">
      ...
      <div className="relative flex items-center gap-3">
        ...
        >
          <div
            className="flex items-center gap-2 rounded-lg border border-emerald-500/40 bg-[#020a14]/90 px-3.5 py-1.5 shadow-[inset_0_0_10px_rgba(0,0,0,0.6)]"
          ...
          <div
            className="flex items-center gap-2 rounded-lg border border-rose-500/40 bg-[#020a14]/90 px-3.5 py-1.5 shadow-[inset_0_0_10px_rgba(0,0,0,0.6)]"
        ...
        <Link
          ...
          className="flex shrink-0 items-center gap-2 rounded-lg border border-cyan-500/50 bg-[#021426]/85 px-4 py-2 text-sm font-black uppercase tracking-widest text-cyan-200 transition hover:border-cyan-400/80 hover:bg-cyan-950/40 hover:shadow-[0_0_14px_rgba(34,211,238,0.35)]"
        >
          <Trophy size={16} />
          <span>Ranking</span>
        </Link>
