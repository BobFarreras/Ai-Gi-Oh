...
export function HomeCardInspector({ selectedCard, selectedCardVersionTier, selectedCardLevel }: HomeCardInspectorProps) {
  return (
      ...
      {selectedCard ? (
        <>
          <div className="mx-auto w-fit origin-top scale-[0.78]">
            <Card card={selectedCard} versionTier={selectedCardVersionTier} level={selectedCardLevel} />
          </div>
