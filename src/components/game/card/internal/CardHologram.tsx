  ...
  if (mode === "lite") {
    return (
      ...
      >
        ...
        />
        {/* Atributos flotantes (energía/ATK/DEF): recupera la lectura del desktop en móvil sin el
            coste del holograma full (sin blur ni animación en bucle). */}
        <CardHologramLiteStats card={card} isExecution={isExecution} />
      </div>
    );
  }
