      ...
      <AnimatePresence mode="wait">
        ...
        >
          <motion.div
            ...
            className="px-5 py-3 rounded-l-2xl border border-cyan-300/60 bg-cyan-500/15 shadow-[0_0_32px_rgba(6,182,212,0.35)]"
          >
            <p className="text-base font-black uppercase tracking-wider text-cyan-100">{activeMessage.left}</p>
          </motion.div>
          <motion.div
            initial={{ x: 120, opacity: 0 }}
            animate={{ x: 0, opacity: 1 }}
            ...
            className="px-5 py-3 rounded-r-2xl border border-red-300/60 bg-red-500/15 shadow-[0_0_32px_rgba(239,68,68,0.35)]"
          >
            <p className="text-base font-black uppercase tracking-wider text-red-100">{activeMessage.right}</p>
          </motion.div>
        </motion.div>
      </AnimatePresence>
    </div>
