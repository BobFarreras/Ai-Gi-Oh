...
export function DuelResultExperienceCard({ entry, card }: DuelResultExperienceCardProps) {
  ...
  return (
    <motion.article initial={{ opacity: 0, y: 8, scale: 0.98 }} animate={{ opacity: 1, y: 0, scale: 1 }} className="relative rounded-xl border border-cyan-300/30 bg-[#03101a]/80 p-3">
      ...
      <motion.div
        ...
        className="relative mx-auto h-[228px] w-[156px] origin-top overflow-hidden rounded-lg"
      >
        <motion.div
