...
2. `DuelResultRewardsPanel.tsx`
   - Panel lateral de recompensas y carta regalo.
3. `DuelResultFireworks.tsx`
   - Efecto visual de victoria.
4. `duel-result-card-density.ts`
   - Regla de densidad visual según cantidad de cartas.
5. `duel-result-reward-summary.ts`
   - Contrato de recompensas del resultado.
6. `use-duel-card-experience-animation.ts`
