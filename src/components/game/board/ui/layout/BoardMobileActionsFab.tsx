...
export function BoardMobileActionsFab({
  ...
  return (
    <div className="absolute top-[4.8rem] left-3 z-[260] flex flex-col items-start gap-2 pointer-events-auto">
      <button aria-label={isOpen ? "Cerrar acciones" : "Abrir acciones"} onClick={() => setIsOpen((v) => !v)} className="rounded-full border border-cyan-400/60 bg-zinc-950/92 p-2.5 text-cyan-300 shadow-[0_0_20px_rgba(34,211,238,0.35)]">
