// src/services/game/match/modes/index.ts - Reexporta controllers concretos por modo de combate con interfaz compartida.
export { TrainingMatchController } from "@/services/game/match/modes/TrainingMatchController";
