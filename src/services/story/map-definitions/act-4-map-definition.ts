...
export const storyAct4MapDefinition: IStoryActMapDefinition = {
  ...
  nodes: [],
  virtualNodes: [
    // Interruptor del puente (SWITCH con beltToggleRect), al fondo del laberinto de la sala derecha alta: al
    // accionarlo se marca interactuado y PERSISTE, invirtiendo la pasarela del puente (anti soft-lock).
