-- docs/supabase/sql/100_new_card_neural_cloud_destroy.sql
-- Magia "Red Neuronal Cloud" (#16): eliges una entity del rival y la destruyes (a su pila de destruidas).
-- Efecto con selección (acción pendiente, patrón LOCK_OPPONENT_ENTITY). Idempotente. Balance provisional.
INSERT INTO public.cards_catalog (
  ...
  ('exec-neural-cloud-destroy', 'Red Neuronal Cloud', 'Elige una entity del rival y destrúyela.', 'EXECUTION', 'NEUTRAL', 4, NULL, NULL, NULL, NULL,
   '/assets/bgs/bg-tech.webp', '/assets/renders/executions/exec-neural-cloud-destroy.webp',
   '{"action":"DESTROY_OPPONENT_ENTITY"}', NULL, '{}', NULL, true)
...
INSERT INTO public.market_card_listings (id, card_id, rarity, price_nexus, stock, is_available) VALUES
  ('listing-exec-neural-cloud-destroy', 'exec-neural-cloud-destroy', 'LEGENDARY', 560, NULL, true)
ON CONFLICT (id) DO UPDATE SET
